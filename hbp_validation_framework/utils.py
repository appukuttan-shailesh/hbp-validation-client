...
def run_test_offline(model="", test_config_file="", reprozip=False):
    ...
    reprozip : boolean
        Run validation using ReproZip to collect files necessary for reproducibility
    ...
    test_result_file = os.path.join(base_folder, "results", "result__" + model.name + "__" + test_timestamp + ".pkl")
...
def run_test(username="", password=None, environment="production", model="", test_instance_id="", test_id="", test_alias="", test_version="", storage_collab_id="", register_result=True, client_obj=None, reprozip=False, **params):
    ...
    **params : list
    ...
    test_result_file = run_test_offline(model=model, test_config_file=test_config_file, reprozip=reprozip)
